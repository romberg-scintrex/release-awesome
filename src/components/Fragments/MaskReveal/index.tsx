...
interface MaskRevealHeroProps {
    profile?: Profile;
}

const MaskRevealHero = ({ profile }: MaskRevealHeroProps) => {
    ...
    const heroBackURL = profile?.heroBackURL ?? globalSettings.heroBackURL;
    const heroFrontURL = profile?.heroFrontURL ?? globalSettings.heroFrontURL;
